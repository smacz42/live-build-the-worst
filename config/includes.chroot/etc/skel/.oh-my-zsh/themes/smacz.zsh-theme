...
prompt_andrewcz_setup () {
  ...
  # Colour scheme
  prompt_andrewcz_color1=${1:-'white'}    # hyphens
  ...
  prompt_l_paren="%F{white}<"
  prompt_r_paren="%F{white}]"
  prompt_u_paren="%F{white}["
  prompt_d_paren="%F{white}>"
  ...
  prompt_line_2="$prompt_gfx_bbox${prompt_gfx_hyphen}%F{white}"
